...
import { getContactsByType, getContacts, createContact, deleteContact, invalidateContactsCache } from '../../lib/data'
...
export function RecordHeader({ contact, pods, activeCampaigns = [], onUpdate }: RecordHeaderProps) {
  ...
  async function handleCreateAndLinkCompany(name: string) {
    ...
    const newCo = await createContact({
      ...
      needs_review: false, company_record_id: null, company_ids: [],
