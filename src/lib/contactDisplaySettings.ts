...
export const COMPANY_STANDARD_PROPERTY_OPTIONS: PropertyOption[] = [
  ...
  { id: 'email', label: 'Email', fieldType: 'Single-line text', group: 'Ways to contact', objectType: 'Company', ownerLabel: 'Real Deal' },
  { id: 'phone', label: 'Phone', fieldType: 'Single-line text', group: 'Ways to contact', objectType: 'Company', ownerLabel: 'Real Deal' },
  { id: 'address', label: 'Address', fieldType: 'Single-line text', group: 'Ways to contact', objectType: 'Company', ownerLabel: 'Real Deal' },
  { id: 'city', label: 'City', fieldType: 'Single select', group: 'Ways to contact', objectType: 'Company', ownerLabel: 'Real Deal' },
  { id: 'state', label: 'State', fieldType: 'Single-line text', group: 'Ways to contact', objectType: 'Company', ownerLabel: 'Real Deal' },
  { id: 'country', label: 'Country', fieldType: 'Single-line text', group: 'Ways to contact', objectType: 'Company', ownerLabel: 'Real Deal' },
  { id: 'global_region', label: 'Global Region', fieldType: 'Single select', group: 'Ways to contact', objectType: 'Company', ownerLabel: 'Real Deal' },
]
