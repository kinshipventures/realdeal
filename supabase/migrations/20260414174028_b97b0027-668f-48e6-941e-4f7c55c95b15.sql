...
VALUES (
  ...
  'deal_flow',
  'active',
  '9582e3a4-14d6-48b5-80ce-4f365b7f266a',
  '2bb6de19-059d-4a94-8cda-4935840818bc'
);

-- Migrate opportunities to campaign_contacts
DO $$
DECLARE
  opp RECORD;
  _contact_id uuid;
...
BEGIN
  FOR opp IN 
    ...
    WHERE o.workspace_id = '2bb6de19-059d-4a94-8cda-4935840818bc'
  LOOP
    ...
    IF _contact_id IS NULL THEN
      ...
      FROM contacts c
      WHERE c.workspace_id = '2bb6de19-059d-4a94-8cda-4935840818bc'
      ...
      IF _contact_id IS NULL THEN
        ...
        VALUES (_contact_id, _contact_name, _first_name, _last_name, _company_name, true, 'Contact', 'Active',
                '9582e3a4-14d6-48b5-80ce-4f365b7f266a', '2bb6de19-059d-4a94-8cda-4935840818bc', 'kv-pipeline-migration');
      END IF;
    END IF;
