...
const lockedPatterns = [
  ...
  /^src\/components\/settings\/GoogleIntegrationSettings\.tsx$/,
  /^src\/components\/import\//,
  /^src\/components\/pods\//,
  /^src\/components\/subpods\//,
  /^src\/components\/dashboard\/widgets\/GmailSyncWidget\.tsx$/,
  /^src\/lib\/googleIntegration\.ts$/,
  /^src\/lib\/googleScopes\.ts$/,
  /^src\/lib\/gmail\.ts$/,
  /^src\/lib\/googleWorkspaceIntegration\.test\.ts$/,
  /^src\/lib\/googleIntegration\.test\.ts$/,
  /^api\/google\//,
  /^api\/cron\/sync-gmail\.ts$/,
  /^api\/_lib\/gmail-sync\.ts$/,
  /^api\/_lib\/gmail-cron\.ts$/,
  /^api\/_lib\/google-connection\.ts$/,
